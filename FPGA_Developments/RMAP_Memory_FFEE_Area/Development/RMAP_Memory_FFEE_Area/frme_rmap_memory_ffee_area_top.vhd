-- frme_rmap_memory_ffee_area_top.vhd
...
entity frme_rmap_memory_ffee_area_top is
	port(
		...
		channel_0_hk_timecode_control_i       : in  std_logic_vector(1 downto 0); --                  --     conduit_end_channel_0_hk_in.timecode_control_signal
		channel_0_hk_timecode_time_i          : in  std_logic_vector(5 downto 0); --                  --                                .timecode_time_signal
		channel_0_hk_rmap_target_status_i     : in  std_logic_vector(7 downto 0); --                  --                                .rmap_target_status_signal
		channel_0_hk_rmap_target_indicate_i   : in  std_logic; --                                     --                                .rmap_target_indicate_signal
		channel_0_hk_spw_link_escape_err_i    : in  std_logic; --                                     --                                .spw_link_escape_err_signal
		channel_0_hk_spw_link_credit_err_i    : in  std_logic; --                                     --                                .spw_link_credit_err_signal
		channel_0_hk_spw_link_parity_err_i    : in  std_logic; --                                     --                                .spw_link_parity_err_signal
		channel_0_hk_spw_link_disconnect_i    : in  std_logic; --                                     --                                .spw_link_disconnect_signal
		channel_0_hk_spw_link_running_i       : in  std_logic; --                                     --                                .spw_link_running_signal
		channel_0_hk_frame_counter_i          : in  std_logic_vector(15 downto 0); --                 --                                .frame_counter_signal
		channel_0_hk_frame_number_i           : in  std_logic_vector(1 downto 0)  := (others => '0'); --                                .frame_number_signal
		channel_0_hk_err_win_wrong_x_coord_i  : in  std_logic; --                                     --                                .err_win_wrong_x_coord_signal
		channel_0_hk_err_win_wrong_y_coord_i  : in  std_logic; --                                     --                                .err_win_wrong_y_coord_signal
		channel_0_hk_err_e_side_buffer_full_i : in  std_logic; --                                     --                                .err_e_side_buffer_full_signal
		channel_0_hk_err_f_side_buffer_full_i : in  std_logic; --                                     --                                .err_f_side_buffer_full_signal
		channel_0_hk_err_invalid_ccd_mode_i   : in  std_logic; --                                     --                                .err_invalid_ccd_mode_signal
		channel_1_hk_timecode_control_i       : in  std_logic_vector(1 downto 0); --                  --     conduit_end_channel_1_hk_in.timecode_control_signal
		channel_1_hk_timecode_time_i          : in  std_logic_vector(5 downto 0); --                  --                                .timecode_time_signal
		channel_1_hk_rmap_target_status_i     : in  std_logic_vector(7 downto 0); --                  --                                .rmap_target_status_signal
		channel_1_hk_rmap_target_indicate_i   : in  std_logic; --                                     --                                .rmap_target_indicate_signal
		channel_1_hk_spw_link_escape_err_i    : in  std_logic; --                                     --                                .spw_link_escape_err_signal
		channel_1_hk_spw_link_credit_err_i    : in  std_logic; --                                     --                                .spw_link_credit_err_signal
		channel_1_hk_spw_link_parity_err_i    : in  std_logic; --                                     --                                .spw_link_parity_err_signal
		channel_1_hk_spw_link_disconnect_i    : in  std_logic; --                                     --                                .spw_link_disconnect_signal
		channel_1_hk_spw_link_running_i       : in  std_logic; --                                     --                                .spw_link_running_signal
		channel_1_hk_frame_counter_i          : in  std_logic_vector(15 downto 0); --                 --                                .frame_counter_signal
		channel_1_hk_frame_number_i           : in  std_logic_vector(1 downto 0)  := (others => '0'); --                                .frame_number_signal
		channel_1_hk_err_win_wrong_x_coord_i  : in  std_logic; --                                     --                                .err_win_wrong_x_coord_signal
		channel_1_hk_err_win_wrong_y_coord_i  : in  std_logic; --                                     --                                .err_win_wrong_y_coord_signal
		channel_1_hk_err_e_side_buffer_full_i : in  std_logic; --                                     --                                .err_e_side_buffer_full_signal
		channel_1_hk_err_f_side_buffer_full_i : in  std_logic; --                                     --                                .err_f_side_buffer_full_signal
		channel_1_hk_err_invalid_ccd_mode_i   : in  std_logic; --                                     --                                .err_invalid_ccd_mode_signal
		channel_2_hk_timecode_control_i       : in  std_logic_vector(1 downto 0); --                  --     conduit_end_channel_2_hk_in.timecode_control_signal
		channel_2_hk_timecode_time_i          : in  std_logic_vector(5 downto 0); --                  --                                .timecode_time_signal
		channel_2_hk_rmap_target_status_i     : in  std_logic_vector(7 downto 0); --                  --                                .rmap_target_status_signal
		channel_2_hk_rmap_target_indicate_i   : in  std_logic; --                                     --                                .rmap_target_indicate_signal
		channel_2_hk_spw_link_escape_err_i    : in  std_logic; --                                     --                                .spw_link_escape_err_signal
		channel_2_hk_spw_link_credit_err_i    : in  std_logic; --                                     --                                .spw_link_credit_err_signal
		channel_2_hk_spw_link_parity_err_i    : in  std_logic; --                                     --                                .spw_link_parity_err_signal
		channel_2_hk_spw_link_disconnect_i    : in  std_logic; --                                     --                                .spw_link_disconnect_signal
		channel_2_hk_spw_link_running_i       : in  std_logic; --                                     --                                .spw_link_running_signal
		channel_2_hk_frame_counter_i          : in  std_logic_vector(15 downto 0); --                 --                                .frame_counter_signal
		channel_2_hk_frame_number_i           : in  std_logic_vector(1 downto 0)  := (others => '0'); --                                .frame_number_signal
		channel_2_hk_err_win_wrong_x_coord_i  : in  std_logic; --                                     --                                .err_win_wrong_x_coord_signal
		channel_2_hk_err_win_wrong_y_coord_i  : in  std_logic; --                                     --                                .err_win_wrong_y_coord_signal
		channel_2_hk_err_e_side_buffer_full_i : in  std_logic; --                                     --                                .err_e_side_buffer_full_signal
		channel_2_hk_err_f_side_buffer_full_i : in  std_logic; --                                     --                                .err_f_side_buffer_full_signal
		channel_2_hk_err_invalid_ccd_mode_i   : in  std_logic; --                                     --                                .err_invalid_ccd_mode_signal
		channel_3_hk_timecode_control_i       : in  std_logic_vector(1 downto 0); --                  --     conduit_end_channel_3_hk_in.timecode_control_signal
		channel_3_hk_timecode_time_i          : in  std_logic_vector(5 downto 0); --                  --                                .timecode_time_signal
		channel_3_hk_rmap_target_status_i     : in  std_logic_vector(7 downto 0); --                  --                                .rmap_target_status_signal
		channel_3_hk_rmap_target_indicate_i   : in  std_logic; --                                     --                                .rmap_target_indicate_signal
		channel_3_hk_spw_link_escape_err_i    : in  std_logic; --                                     --                                .spw_link_escape_err_signal
		channel_3_hk_spw_link_credit_err_i    : in  std_logic; --                                     --                                .spw_link_credit_err_signal
		channel_3_hk_spw_link_parity_err_i    : in  std_logic; --                                     --                                .spw_link_parity_err_signal
		channel_3_hk_spw_link_disconnect_i    : in  std_logic; --                                     --                                .spw_link_disconnect_signal
		channel_3_hk_spw_link_running_i       : in  std_logic; --                                     --                                .spw_link_running_signal
		channel_3_hk_frame_counter_i          : in  std_logic_vector(15 downto 0); --                 --                                .frame_counter_signal
		channel_3_hk_frame_number_i           : in  std_logic_vector(1 downto 0)  := (others => '0'); --                                .frame_number_signal
		channel_3_hk_err_win_wrong_x_coord_i  : in  std_logic; --                                     --                                .err_win_wrong_x_coord_signal
		channel_3_hk_err_win_wrong_y_coord_i  : in  std_logic; --                                     --                                .err_win_wrong_y_coord_signal
		channel_3_hk_err_e_side_buffer_full_i : in  std_logic; --                                     --                                .err_e_side_buffer_full_signal
		channel_3_hk_err_f_side_buffer_full_i : in  std_logic; --                                     --                                .err_f_side_buffer_full_signal
		channel_3_hk_err_invalid_ccd_mode_i   : in  std_logic; --                                     --                                .err_invalid_ccd_mode_signal
...
end entity frme_rmap_memory_ffee_area_top;

architecture rtl of frme_rmap_memory_ffee_area_top is
	...
	signal s_fee_wr_rmap_cfg_hk_in             : t_frme_ffee_rmap_write_in;
	signal s_fee_wr_rmap_cfg_hk_out            : t_frme_ffee_rmap_write_out;
	signal s_fee_rd_rmap_cfg_hk_in             : t_frme_ffee_rmap_read_in;
	signal s_fee_rd_rmap_cfg_hk_out            : t_frme_ffee_rmap_read_out;
	-- avs rmap signals
	signal s_avalon_mm_wr_rmap_in              : t_frme_avalon_mm_rmap_ffee_write_in;
	signal s_avalon_mm_wr_rmap_out             : t_frme_avalon_mm_rmap_ffee_write_out;
	signal s_avalon_mm_rd_rmap_in              : t_frme_avalon_mm_rmap_ffee_read_in;
	signal s_avalon_mm_rd_rmap_out             : t_frme_avalon_mm_rmap_ffee_read_out;
	-- avm rmap & fee rmap win signals
	signal s_avm_rmap_rd_address               : std_logic_vector((c_FRME_AVM_ADRESS_SIZE - 1) downto 0);
	signal s_avm_rmap_wr_address               : std_logic_vector((c_FRME_AVM_ADRESS_SIZE - 1) downto 0);
	signal s_fee_wr_rmap_win_in                : t_frme_ffee_rmap_write_in;
	signal s_fee_wr_rmap_win_out               : t_frme_ffee_rmap_write_out;
	signal s_fee_rd_rmap_win_in                : t_frme_ffee_rmap_read_in;
	signal s_fee_rd_rmap_win_out               : t_frme_ffee_rmap_read_out;
...
begin
	...
	frme_rmap_mem_area_ffee_arbiter_ent_inst : entity work.frme_rmap_mem_area_ffee_arbiter_ent
		port map(
			clk_i                             => a_avs_clock,
			rst_i                             => a_reset,
	...
	frme_rmap_mem_area_ffee_read_ent_inst : entity work.frme_rmap_mem_area_ffee_read_ent
		port map(
			clk_i               => a_avs_clock,
			rst_i               => a_reset,
	...
	frme_rmap_mem_area_ffee_write_ent_inst : entity work.frme_rmap_mem_area_ffee_write_ent
		port map(
			clk_i               => a_avs_clock,
			rst_i               => a_reset,
	...
	frme_avm_rmap_ffee_read_ent_inst : entity work.frme_avm_rmap_ffee_read_ent
		port map(
			clk_i                             => a_avs_clock,
			rst_i                             => a_reset,
	...
	frme_avm_rmap_ffee_write_ent_inst : entity work.frme_avm_rmap_ffee_write_ent
		port map(
			clk_i                             => a_avs_clock,
			rst_i                             => a_reset,
	...
	-- frme ffee rmap error clear manager
	p_frme_ffee_rmap_error_clear_manager : process(a_avs_clock, a_reset) is
	begin
		if (a_reset) = '1' then
			...
			if ((s_hk_err_win_wrong_x_coord_delayed = '0') and (channel_0_hk_err_win_wrong_x_coord_i = '1')) then
				s_rmap_mem_rd_area.reg_34_hk.error_flags_window_pixels_fall_outside_cdd_boundary_due_to_wrong_x_coordinate <= '1';
			end if;
			if ((s_hk_err_win_wrong_y_coord_delayed = '0') and (channel_0_hk_err_win_wrong_y_coord_i = '1')) then
				s_rmap_mem_rd_area.reg_34_hk.error_flags_window_pixels_fall_outside_cdd_boundary_due_to_wrong_y_coordinate <= '1';
			end if;
			if ((s_hk_err_e_side_buffer_full_delayed = '0') and (channel_0_hk_err_e_side_buffer_full_i = '1')) then
				s_rmap_mem_rd_area.reg_34_hk.error_flags_e_side_pixel_external_sram_buffer_is_full <= '1';
			end if;
			if ((s_hk_err_f_side_buffer_full_delayed = '0') and (channel_0_hk_err_f_side_buffer_full_i = '1')) then
				s_rmap_mem_rd_area.reg_34_hk.error_flags_f_side_pixel_external_sram_buffer_is_full <= '1';
			end if;
			if ((s_hk_err_invalid_ccd_mode_delayed = '0') and (channel_0_hk_err_invalid_ccd_mode_i = '1')) then
				s_rmap_mem_rd_area.reg_34_hk.error_flags_invalid_ccd_mode <= '1';
			end if;
			if ((s_spw_err_link_escape_err = '0') and (channel_0_hk_spw_link_escape_err_i = '1')) then
				s_rmap_mem_rd_area.reg_34_hk.error_flags_invalid_ccd_mode <= '1';
			end if;
			if ((s_spw_err_link_credit_err = '0') and (channel_0_hk_spw_link_credit_err_i = '1')) then
				s_rmap_mem_rd_area.reg_34_hk.error_flags_invalid_ccd_mode <= '1';
			end if;
			if ((s_spw_err_link_parity_err = '0') and (channel_0_hk_spw_link_parity_err_i = '1')) then
				s_rmap_mem_rd_area.reg_34_hk.error_flags_invalid_ccd_mode <= '1';
			end if;
			if ((s_spw_err_link_disconnect = '0') and (channel_0_hk_spw_link_disconnect_i = '1')) then
				s_rmap_mem_rd_area.reg_34_hk.error_flags_invalid_ccd_mode <= '1';
			end if;
			...
			-- delay error signals
			s_hk_err_win_wrong_x_coord_delayed  <= channel_0_hk_err_win_wrong_x_coord_i;
			s_hk_err_win_wrong_y_coord_delayed  <= channel_0_hk_err_win_wrong_y_coord_i;
			s_hk_err_e_side_buffer_full_delayed <= channel_0_hk_err_e_side_buffer_full_i;
			s_hk_err_f_side_buffer_full_delayed <= channel_0_hk_err_f_side_buffer_full_i;
			s_hk_err_invalid_ccd_mode_delayed   <= channel_0_hk_err_invalid_ccd_mode_i;
			s_spw_err_link_escape_err           <= channel_0_hk_spw_link_escape_err_i;
			s_spw_err_link_credit_err           <= channel_0_hk_spw_link_credit_err_i;
			s_spw_err_link_parity_err           <= channel_0_hk_spw_link_parity_err_i;
			s_spw_err_link_disconnect           <= channel_0_hk_spw_link_disconnect_i;
		end if;
	end process p_frme_ffee_rmap_error_clear_manager;

	-- channel hk for rmap read area
	s_rmap_mem_rd_area.reg_32_hk.spw_status_timecode_from_spw(7 downto 6) <= channel_0_hk_timecode_control_i;
	s_rmap_mem_rd_area.reg_32_hk.spw_status_timecode_from_spw(5 downto 0) <= channel_0_hk_timecode_time_i;
	s_rmap_mem_rd_area.reg_32_hk.spw_status_rmap_target_status            <= channel_0_hk_rmap_target_status_i;
	s_rmap_mem_rd_area.reg_32_hk.spw_status_rmap_target_indicate          <= channel_0_hk_rmap_target_indicate_i;
	s_rmap_mem_rd_area.reg_32_hk.spw_status_stat_link_running             <= channel_0_hk_spw_link_running_i;
	s_rmap_mem_rd_area.reg_33_hk.frame_counter                            <= channel_0_hk_frame_counter_i;
	s_rmap_mem_rd_area.reg_33_hk.frame_number                             <= channel_0_hk_frame_number_i;

end architecture rtl;                   -- of frme_rmap_memory_ffee_area_top
