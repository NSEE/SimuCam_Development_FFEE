...
bool bWindCopyMebWindowingParam(alt_u32 uliWindowingParamAddr, alt_u8 ucMemoryId, alt_u8 ucCommCh, alt_u8 ucAebId);  /* Copy the meb windowing parameters from the memory address to the specified channel */
