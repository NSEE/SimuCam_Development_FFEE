...
//scfifo ADD_RAM_OUTPUT_REGISTER="ON" ALMOST_EMPTY_VALUE=2 ALMOST_FULL_VALUE=8190 DEVICE_FAMILY="Stratix IV" LPM_NUMWORDS=8192 LPM_SHOWAHEAD="OFF" LPM_WIDTH=8 LPM_WIDTHU=13 OVERFLOW_CHECKING="ON" RAM_BLOCK_TYPE="M9K" UNDERFLOW_CHECKING="ON" USE_EAB="ON" aclr almost_empty almost_full clock data empty full q rdreq sclr usedw wrreq INTENDED_DEVICE_FAMILY="Stratix IV" lpm_hint="RAM_BLOCK_TYPE=M9K"
...
//a_dpfifo ADD_RAM_OUTPUT_REGISTER="ON" ALLOW_RWCYCLE_WHEN_FULL="OFF" DEVICE_FAMILY="Stratix IV" LPM_NUMWORDS=8192 LPM_SHOWAHEAD="OFF" lpm_width=8 lpm_widthu=13 OVERFLOW_CHECKING="ON" UNDERFLOW_CHECKING="ON" aclr clock data empty full q rreq sclr usedw wreq INTENDED_DEVICE_FAMILY="Stratix IV" lpm_hint="RAM_BLOCK_TYPE=M9K"
//VERSION_BEGIN 18.1 cbx_altdpram 2018:09:12:13:04:24:SJ cbx_altera_counter 2018:09:12:13:04:24:SJ cbx_altera_syncram 2018:09:12:13:04:24:SJ cbx_altera_syncram_nd_impl 2018:09:12:13:04:24:SJ cbx_altsyncram 2018:09:12:13:04:24:SJ cbx_cycloneii 2018:09:12:13:04:24:SJ cbx_fifo_common 2018:09:12:13:04:24:SJ cbx_lpm_add_sub 2018:09:12:13:04:24:SJ cbx_lpm_compare 2018:09:12:13:04:24:SJ cbx_lpm_counter 2018:09:12:13:04:24:SJ cbx_lpm_decode 2018:09:12:13:04:24:SJ cbx_lpm_mux 2018:09:12:13:04:24:SJ cbx_mgl 2018:09:12:13:10:36:SJ cbx_nadder 2018:09:12:13:04:24:SJ cbx_scfifo 2018:09:12:13:04:24:SJ cbx_stratix 2018:09:12:13:04:24:SJ cbx_stratixii 2018:09:12:13:04:24:SJ cbx_stratixiii 2018:09:12:13:04:24:SJ cbx_stratixv 2018:09:12:13:04:24:SJ cbx_util_mgl 2018:09:12:13:04:24:SJ  VERSION_END


//altsyncram ADDRESS_ACLR_A="NONE" ADDRESS_ACLR_B="NONE" ADDRESS_REG_B="CLOCK1" CLOCK_ENABLE_INPUT_B="BYPASS" DEVICE_FAMILY="Stratix IV" ENABLE_ECC="FALSE" INDATA_ACLR_A="NONE" NUMWORDS_A=8192 NUMWORDS_B=8192 OPERATION_MODE="DUAL_PORT" OUTDATA_ACLR_B="NONE" OUTDATA_REG_B="CLOCK1" RAM_BLOCK_TYPE="M9K" WIDTH_A=8 WIDTH_B=8 WIDTH_BYTEENA_A=1 WIDTH_ECCSTATUS=2 WIDTHAD_A=13 WIDTHAD_B=13 WRCONTROL_ACLR_A="NONE" address_a address_b clock0 clock1 clocken1 data_a q_b wren_a
...
//lpm_compare DEVICE_FAMILY="Stratix IV" LPM_WIDTH=13 ONE_INPUT_IS_CONSTANT="YES" aeb dataa datab
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  send_buffer_0_sc_fifo_cmpr
	( 
	aeb,
	dataa,
...
endmodule //send_buffer_0_sc_fifo_cmpr


//lpm_counter DEVICE_FAMILY="Stratix IV" lpm_direction="UP" lpm_port_updown="PORT_UNUSED" lpm_width=12 aclr clock cnt_en q sclr
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  send_buffer_0_sc_fifo_cntr12
	( 
	aclr,
	clock,
	cnt_en,
...
`endif
	...
	assign
		...
		updown_lsb = updown_dir,
		updown_other_bits = ((~ external_cin) | updown_dir);
endmodule //send_buffer_0_sc_fifo_cntr12

//synthesis_resources = lut 38 M9K 8 reg 57 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
`endif
	...
	wire  [11:0]   wire_rd_ptr_msb_q;
	wire  [12:0]   wire_usedw_counter_q;
	wire  [12:0]   wire_wr_ptr_q;
	wire  asynch_read_counter_enable;
	wire  empty_out;
	wire  full_out;
	wire  pulse_ram_output;
	wire  [12:0]  ram_read_address;
	wire  [12:0]  rd_ptr;
	wire  usedw_is_0;
	wire  usedw_is_1;
	wire  usedw_is_2;
	...
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		if (aclr == 1'b1) low_addressa <= 13'b0;
		else  low_addressa <= ({13{(~ sclr)}} & (({13{asynch_read_counter_enable}} & rd_ptr) | ({13{(~ asynch_read_counter_enable)}} & low_addressa)));
	// synopsys translate_off
	initial
		rd_ptr_lsb = 0;
	// synopsys translate_on
	...
	send_buffer_0_sc_fifo_cmpr   almost_full_comparer
	( 
	.aeb(wire_almost_full_comparer_aeb),
	.dataa({13{1'b1}}),
	.datab(wire_usedw_counter_q));
	send_buffer_0_sc_fifo_cmpr   two_comparison
	( 
	.aeb(wire_two_comparison_aeb),
	.dataa(wire_usedw_counter_q),
	.datab({{11{1'b0}}, 1'b1, 1'b0}));
	send_buffer_0_sc_fifo_cntr   rd_ptr_msb
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.q(wire_rd_ptr_msb_q),
	.sclr(sclr));
	send_buffer_0_sc_fifo_cntr1   usedw_counter
	( 
	.aclr(aclr),
	.clock(clock),
	...
	.sclr(sclr),
	.updown(valid_wreq));
	send_buffer_0_sc_fifo_cntr12   wr_ptr
	( 
	.aclr(aclr),
	.clock(clock),
	.cnt_en(valid_wreq),
	...
	assign
		...
		q = wire_FIFOram_q_b,
		ram_read_address = (({13{(~ asynch_read_counter_enable)}} & low_addressa) | ({13{asynch_read_counter_enable}} & rd_ptr)),
...
//synthesis_resources = lut 38 M9K 8 reg 59 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
`endif
	...
	wire  [12:0]  wire_ae;
	wire  [12:0]  wire_af;
	wire  [12:0]  wire_pre_ae;
	wire  [12:0]  wire_pre_af;
	...
	always @ ( posedge clock or  posedge aclr)
		...
		else  dffe_af <= ((dffe_af & (dffe_af ^ (sclr | ((comparison_af12 & (~ wrreq)) & rdreq)))) | ((~ dffe_af) & ((((~ sclr) & comparison_pre_af12) & wrreq) & (~ rdreq))));
	// synopsys translate_off
	initial
		dffe_nae = 0;
	// synopsys translate_on
	always @ ( posedge clock or  posedge aclr)
		...
		else  dffe_nae <= ((dffe_nae & (dffe_nae ^ (sclr | ((comparison_ae12 & (~ wrreq)) & rdreq)))) | ((~ dffe_nae) & ((((~ sclr) & comparison_pre_ae12) & wrreq) & (~ rdreq))));
	assign
		...
		q = wire_dpfifo_q,
		usedw = wire_dpfifo_usedw,
		wire_ae = {{11{1'b1}}, 1'b0, 1'b1},
		wire_af = {{12{1'b0}}, 1'b1},
		wire_pre_ae = {{12{1'b1}}, 1'b0},
		wire_pre_af = {{11{1'b0}}, 1'b1, 1'b0};
...
module send_buffer_0_sc_fifo (
	...
	wire [12:0] usedw = sub_wire5[12:0];
