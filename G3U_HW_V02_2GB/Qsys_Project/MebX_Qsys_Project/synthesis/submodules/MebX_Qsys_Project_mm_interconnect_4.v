...
module MebX_Qsys_Project_mm_interconnect_4 (
		...
		input  wire [30:0]  m1_clock_bridge_comm_m0_address,                                 //                                   m1_clock_bridge_comm_m0.address
		output wire         m1_clock_bridge_comm_m0_waitrequest,                             //                                                          .waitrequest
		input  wire [2:0]   m1_clock_bridge_comm_m0_burstcount,                              //                                                          .burstcount
		input  wire [31:0]  m1_clock_bridge_comm_m0_byteenable,                              //                                                          .byteenable
		input  wire         m1_clock_bridge_comm_m0_read,                                    //                                                          .read
		output wire [255:0] m1_clock_bridge_comm_m0_readdata,                                //                                                          .readdata
		output wire         m1_clock_bridge_comm_m0_readdatavalid,                           //                                                          .readdatavalid
		input  wire         m1_clock_bridge_comm_m0_write,                                   //                                                          .write
		input  wire [255:0] m1_clock_bridge_comm_m0_writedata,                               //                                                          .writedata
		input  wire         m1_clock_bridge_comm_m0_debugaccess,                             //                                                          .debugaccess
	...
	wire          m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_waitrequest;      // m1_clock_bridge_comm_m0_agent:av_waitrequest -> m1_clock_bridge_comm_m0_translator:uav_waitrequest
	wire  [255:0] m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_readdata;         // m1_clock_bridge_comm_m0_agent:av_readdata -> m1_clock_bridge_comm_m0_translator:uav_readdata
	wire          m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_debugaccess;      // m1_clock_bridge_comm_m0_translator:uav_debugaccess -> m1_clock_bridge_comm_m0_agent:av_debugaccess
	wire   [30:0] m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_address;          // m1_clock_bridge_comm_m0_translator:uav_address -> m1_clock_bridge_comm_m0_agent:av_address
	wire          m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_read;             // m1_clock_bridge_comm_m0_translator:uav_read -> m1_clock_bridge_comm_m0_agent:av_read
	wire   [31:0] m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_byteenable;       // m1_clock_bridge_comm_m0_translator:uav_byteenable -> m1_clock_bridge_comm_m0_agent:av_byteenable
	wire          m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_readdatavalid;    // m1_clock_bridge_comm_m0_agent:av_readdatavalid -> m1_clock_bridge_comm_m0_translator:uav_readdatavalid
	wire          m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_lock;             // m1_clock_bridge_comm_m0_translator:uav_lock -> m1_clock_bridge_comm_m0_agent:av_lock
	wire          m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_write;            // m1_clock_bridge_comm_m0_translator:uav_write -> m1_clock_bridge_comm_m0_agent:av_write
	wire  [255:0] m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_writedata;        // m1_clock_bridge_comm_m0_translator:uav_writedata -> m1_clock_bridge_comm_m0_agent:av_writedata
	wire    [7:0] m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_burstcount;       // m1_clock_bridge_comm_m0_translator:uav_burstcount -> m1_clock_bridge_comm_m0_agent:av_burstcount
	wire          rsp_mux_001_src_valid;                                                         // rsp_mux_001:src_valid -> m1_clock_bridge_comm_m0_agent:rp_valid
	wire  [364:0] rsp_mux_001_src_data;                                                          // rsp_mux_001:src_data -> m1_clock_bridge_comm_m0_agent:rp_data
	wire          rsp_mux_001_src_ready;                                                         // m1_clock_bridge_comm_m0_agent:rp_ready -> rsp_mux_001:src_ready
	wire    [2:0] rsp_mux_001_src_channel;                                                       // rsp_mux_001:src_channel -> m1_clock_bridge_comm_m0_agent:rp_channel
	wire          rsp_mux_001_src_startofpacket;                                                 // rsp_mux_001:src_startofpacket -> m1_clock_bridge_comm_m0_agent:rp_startofpacket
	wire          rsp_mux_001_src_endofpacket;                                                   // rsp_mux_001:src_endofpacket -> m1_clock_bridge_comm_m0_agent:rp_endofpacket
	...
	wire  [364:0] rsp_mux_002_src_data;                                                          // rsp_mux_002:src_data -> m1_clock_bridge_ftdi_m0_agent:rp_data
	wire          rsp_mux_002_src_ready;                                                         // m1_clock_bridge_ftdi_m0_agent:rp_ready -> rsp_mux_002:src_ready
	wire    [2:0] rsp_mux_002_src_channel;                                                       // rsp_mux_002:src_channel -> m1_clock_bridge_ftdi_m0_agent:rp_channel
	...
	wire          m1_clock_bridge_comm_m0_agent_cp_valid;                                        // m1_clock_bridge_comm_m0_agent:cp_valid -> router_001:sink_valid
	wire  [364:0] m1_clock_bridge_comm_m0_agent_cp_data;                                         // m1_clock_bridge_comm_m0_agent:cp_data -> router_001:sink_data
	wire          m1_clock_bridge_comm_m0_agent_cp_ready;                                        // router_001:sink_ready -> m1_clock_bridge_comm_m0_agent:cp_ready
	wire          m1_clock_bridge_comm_m0_agent_cp_startofpacket;                                // m1_clock_bridge_comm_m0_agent:cp_startofpacket -> router_001:sink_startofpacket
	wire          m1_clock_bridge_comm_m0_agent_cp_endofpacket;                                  // m1_clock_bridge_comm_m0_agent:cp_endofpacket -> router_001:sink_endofpacket
	...
	wire  [364:0] m1_clock_bridge_ftdi_m0_agent_cp_data;                                         // m1_clock_bridge_ftdi_m0_agent:cp_data -> router_002:sink_data
	...
	altera_merlin_master_translator #(
		...
		.AV_LINEWRAPBURSTS           (0),
		.AV_REGISTERINCOMINGSIGNALS  (0)
	) m1_clock_bridge_comm_m0_translator (
		.clk                    (m1_ddr2_memory_afi_half_clk_clk),                                            //                       clk.clk
		.reset                  (m1_clock_bridge_general_m0_reset_reset_bridge_in_reset_reset),               //                     reset.reset
		.uav_address            (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_address),       // avalon_universal_master_0.address
		.uav_burstcount         (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_burstcount),    //                          .burstcount
		.uav_read               (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_read),          //                          .read
		.uav_write              (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_write),         //                          .write
		.uav_waitrequest        (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_waitrequest),   //                          .waitrequest
		.uav_readdatavalid      (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_readdatavalid), //                          .readdatavalid
		.uav_byteenable         (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_byteenable),    //                          .byteenable
		.uav_readdata           (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_readdata),      //                          .readdata
		.uav_writedata          (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_writedata),     //                          .writedata
		.uav_lock               (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_lock),          //                          .lock
		.uav_debugaccess        (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_debugaccess),   //                          .debugaccess
		.av_address             (m1_clock_bridge_comm_m0_address),                                            //      avalon_anti_master_0.address
		.av_waitrequest         (m1_clock_bridge_comm_m0_waitrequest),                                        //                          .waitrequest
		.av_burstcount          (m1_clock_bridge_comm_m0_burstcount),                                         //                          .burstcount
		.av_byteenable          (m1_clock_bridge_comm_m0_byteenable),                                         //                          .byteenable
		.av_read                (m1_clock_bridge_comm_m0_read),                                               //                          .read
		.av_readdata            (m1_clock_bridge_comm_m0_readdata),                                           //                          .readdata
		.av_readdatavalid       (m1_clock_bridge_comm_m0_readdatavalid),                                      //                          .readdatavalid
		.av_write               (m1_clock_bridge_comm_m0_write),                                              //                          .write
		.av_writedata           (m1_clock_bridge_comm_m0_writedata),                                          //                          .writedata
		.av_debugaccess         (m1_clock_bridge_comm_m0_debugaccess),                                        //                          .debugaccess
		.av_beginbursttransfer  (1'b0),                                                                       //               (terminated)
		.av_begintransfer       (1'b0),                                                                       //               (terminated)
		.av_chipselect          (1'b0),                                                                       //               (terminated)
		.av_lock                (1'b0),                                                                       //               (terminated)
	...
	altera_merlin_master_agent #(
		...
		.USE_READRESPONSE          (0),
		.USE_WRITERESPONSE         (0)
	) m1_clock_bridge_comm_m0_agent (
		.clk                   (m1_ddr2_memory_afi_half_clk_clk),                                            //       clk.clk
		.reset                 (m1_clock_bridge_general_m0_reset_reset_bridge_in_reset_reset),               // clk_reset.reset
		.av_address            (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_address),       //        av.address
		.av_write              (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_write),         //          .write
		.av_read               (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_read),          //          .read
		.av_writedata          (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_writedata),     //          .writedata
		.av_readdata           (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_readdata),      //          .readdata
		.av_waitrequest        (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_waitrequest),   //          .waitrequest
		.av_readdatavalid      (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_readdatavalid), //          .readdatavalid
		.av_byteenable         (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_byteenable),    //          .byteenable
		.av_burstcount         (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_burstcount),    //          .burstcount
		.av_debugaccess        (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_debugaccess),   //          .debugaccess
		.av_lock               (m1_clock_bridge_comm_m0_translator_avalon_universal_master_0_lock),          //          .lock
		.cp_valid              (m1_clock_bridge_comm_m0_agent_cp_valid),                                     //        cp.valid
		.cp_data               (m1_clock_bridge_comm_m0_agent_cp_data),                                      //          .data
		.cp_startofpacket      (m1_clock_bridge_comm_m0_agent_cp_startofpacket),                             //          .startofpacket
		.cp_endofpacket        (m1_clock_bridge_comm_m0_agent_cp_endofpacket),                               //          .endofpacket
		.cp_ready              (m1_clock_bridge_comm_m0_agent_cp_ready),                                     //          .ready
	...
	MebX_Qsys_Project_mm_interconnect_4_router router_001 (
		.sink_ready         (m1_clock_bridge_comm_m0_agent_cp_ready),                       //      sink.ready
		.sink_valid         (m1_clock_bridge_comm_m0_agent_cp_valid),                       //          .valid
		.sink_data          (m1_clock_bridge_comm_m0_agent_cp_data),                        //          .data
		.sink_startofpacket (m1_clock_bridge_comm_m0_agent_cp_startofpacket),               //          .startofpacket
		.sink_endofpacket   (m1_clock_bridge_comm_m0_agent_cp_endofpacket),                 //          .endofpacket
		.clk                (m1_ddr2_memory_afi_half_clk_clk),                              //       clk.clk
		.reset              (m1_clock_bridge_general_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MebX_Qsys_Project_mm_interconnect_4_router router_002 (
	...
	MebX_Qsys_Project_mm_interconnect_4_router_003 router_003 (
	...
	MebX_Qsys_Project_mm_interconnect_4_cmd_demux cmd_demux_002 (
		.clk                (m1_ddr2_memory_afi_half_clk_clk),                              //       clk.clk
		.reset              (m1_clock_bridge_general_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	MebX_Qsys_Project_mm_interconnect_4_rsp_mux rsp_mux_002 (
		.clk                 (m1_ddr2_memory_afi_half_clk_clk),                              //       clk.clk
		.reset               (m1_clock_bridge_general_m0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
