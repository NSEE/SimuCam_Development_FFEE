...
architecture rtl of fdrm_rmap_memory_ffee_deb_area_top is
    ...
    -- mem area signals
    signal s_memarea_wraddress         : std_logic_vector(4 downto 0);
    ...
    signal s_memarea_rdaddress         : std_logic_vector(4 downto 0);
...
begin
    ...
    fdrm_mem_area_altsyncram_controller_inst : entity work.fdrm_mem_area_altsyncram_controller
        port map(
            clk_i                  => a_avs_clock,
            rst_i                  => a_reset,
